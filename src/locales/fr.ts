export default {
  ...
  botProfitComparison: {
    ...
    bots: 'Bots',
    trades: 'Trades',
    tradeCount: '{n} trades sur la période',
    sortBy: 'Trier par',
    sortProfit: 'Profit',
    sortMagnitude: 'Ampleur',
    sortName: 'Nom',
    exportPNG: 'Exporter en image',
    noData: 'Aucun trade fermé pour les bots et la période sélectionnés',
  },
  volumeComparator: {
  ...
  botComparison: {
    ...
    sortByCurrentProfit: 'Profit courant',
    sortByBalance: 'Solde',
  ...
  maxDrawdownCard: {
    ...
    none: 'Aucun drawdown',
    noneDesc: 'Aucune baisse pic-à-creux enregistrée.',
    realized: 'Réalisé (fermé)',
    inclOpen: 'Incl. positions ouvertes',
    realizedShort: 'Réal.',
    openShort: 'Ouv.',
    ...
    peak: 'Plus haut',
    trough: 'Plus bas',
    openPositions: 'Positions ouvertes (actuel → plus bas)',
    low: 'plus bas',
    responsibleTrades: 'Trades responsables',
    tradesInWindow: 'Trades pendant le drawdown',
    group: 'Groupe',
    summary: 'Résumé',
  },
  ...
  botList: {
    ...
    addFirstBot: 'Ajouter votre premier bot',
    emptyState: 'Aucun bot connecté pour le moment. Ajoutez-en un pour commencer.',
    viewFlat: 'Passer en liste simple',
    viewGrouped: 'Grouper par dossier',
    noMatches: 'Aucun bot ne correspond aux filtres.',
    autoRefresh: 'Rafraîchissement auto',
    onlineSince: 'actif {duration}',
    dry: 'Dry',
    live: 'Live',
    dryTooltip: 'Mode dry-run — trades simulés, sans argent réel.',
    liveTooltip: 'Mode live — trading avec des fonds réels.',
    spotTooltip: 'Spot : achat et vente uniquement, sans levier ni vente à découvert.',
    futuresTooltip: 'Futures : supporte short, long et trading avec levier.',
    sort: {
      manual: 'Ordre manuel',
      name: 'Nom (A→Z)',
    ...
    noFoldersYet: 'Aucun dossier — créez-en un ci-dessous.',
    newFolder: 'Nouveau dossier',
    newFolderName: 'Nom du dossier',
    createFolder: 'Créer le dossier',
    renameFolder: 'Renommer le dossier',
    deleteFolder: 'Supprimer le dossier',
    emptyFolder: 'Vide — déplacez un bot ici.',
  },
